...
const FunFacts = () => (
  <ul className="list-disc pl-5 space-y-2">
    ...
    <li>Greyhounds can reach speeds of up to 45 miles per hour.</li>
    <li>The tallest dog ever recorded was a Great Dane named Zeus, who stood at 44 inches tall.</li>
  </ul>
);
